...
export function origin(){const raw=process.env.APP_ORIGIN;if(!raw)fail('Falta configurar APP_ORIGIN',503);const u=new URL(raw);if(process.env.VERCEL&&u.protocol!=='https:')fail('APP_ORIGIN debe usar HTTPS',503);return u.origin;}
